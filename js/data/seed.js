  ...
  return [
    {
      ...
      format: 'physical',
      status: 'reading',
      shelves: ['2026 goal', 'series reads'],
    ...
    },
    {
      ...
      genre: 'Gothic',
      description:
        'A respectable London doctor keeps a laboratory, a locked cabinet, and a will leaving everything to a man his friends have never met.',
      format: 'physical',
      status: 'finished',
      shelves: ['2026 goal'],
      review: 'Still the best short novel about a locked door.',
